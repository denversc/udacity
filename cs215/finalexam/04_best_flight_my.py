...
def find_best_flights(flights, origin, destination):
    ...
    def pop_shortest_path_from_partial():
        shortest = None
        for node in partial:
            (cost, path) = partial[node]
